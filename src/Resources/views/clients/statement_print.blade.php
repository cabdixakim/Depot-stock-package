...
@section('content')
@php
  // Brand with safe fallbacks (no "Laravel" unless that's literally app.name)
  $brandName =
...
<div class="wrap">
  <div style="display:flex;justify-content:space-between;align-items:flex-end;">
    <div>
      {{-- ✅ Beautiful brand/logo (PRINT ONLY) --}}
      <div class="brand">
        @if($logoUrl)
        ...
        <div>
          <div class="brand-word">{{ $brandName }}</div>
          <div class="brand-sub">Client statement</div>
        </div>
      </div>
